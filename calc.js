...
document.getElementById("zerozero").addEventListener("click", () => {
	clearZero();
  clearResult()
  resultNo.insertAdjacentHTML("beforeend", "00");
  document.getElementById("zerozero").classList.remove("btn-number");
  document.getElementById("zerozero").classList.add("btn-active");

  function clearActive() {
    document.getElementById("zerozero").classList.remove("btn-active");
    document.getElementById("zerozero").classList.add("btn-number");
  }
  setTimeout(clearActive, 100);
});
